...
public class HuodongcanyuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HuodongcanyuEntity() {
		
	}
	
	public HuodongcanyuEntity(T t) {
		try {
	 ...
	 * 设置：举办日期
	 */
	public void setJubanriqi(String jubanriqi) {
		this.jubanriqi = jubanriqi;
	}
	/**
	 * 获取：举办日期
	 */
	public String getJubanriqi() {
		return jubanriqi;
	}
	/**
	 * 设置：举办社团
