...
import center from '@/views/center'
    ...
    import xiaoyuanshetuan from '@/views/modules/xiaoyuanshetuan/list'
    import huiyuanshenqing from '@/views/modules/huiyuanshenqing/list'
    import chat from '@/views/modules/chat/list'
    import shetuanshenqingxinxi from '@/views/modules/shetuanshenqingxinxi/list'
...
const routes = [{
	...
	path: '/shetuanhuodong',
      ...
      ,{
	path: '/xiaoyuanshetuan',
        name: '校园社团',
        component: xiaoyuanshetuan
      }
      ,{
	...
	path: '/chat',
      ...
      ,{
	path: '/shetuanshenqingxinxi',
        name: '社团申请信息',
        component: shetuanshenqingxinxi
      }
      ,{
	path: '/huiyuan',
        name: '会员',
