  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">高校社团管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学号" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.xuehao" autocomplete="off" placeholder="学号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   <div class="label">密码</div>
			...
			<el-form-item label="电话" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.dianhua" autocomplete="off" placeholder="电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   <div class="label">邮箱</div>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.xuehao) && `huiyuan` == this.tableName){
        this.$message.error(`学号不能为空`);
        return
      }
      ...
      if(`huiyuan` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
