...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `shetuanshenqingxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.shenqingliyou = this.ruleForm.shenqingliyou.replace(reg,'../../../ssmhn4b5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shetuanshenqingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shetuanshenqingxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
