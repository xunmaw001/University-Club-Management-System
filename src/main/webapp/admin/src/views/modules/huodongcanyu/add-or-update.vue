<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办日期" prop="jubanriqi">
          <el-input v-model="ruleForm.jubanriqi" 
              placeholder="举办日期" clearable  :readonly="ro.jubanriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举办日期" prop="jubanriqi">
              <el-input v-model="ruleForm.jubanriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办社团" prop="jubanshetuan">
          <el-input v-model="ruleForm.jubanshetuan" 
              placeholder="举办社团" clearable  :readonly="ro.jubanshetuan"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.canyushijian" label="参与时间" prop="canyushijian">
              <el-input v-model="ruleForm.canyushijian" 
                placeholder="参与时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huodongcanyu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huodongcanyuCrossAddOrUpdateFlag = false;
                  this.parent.search();
