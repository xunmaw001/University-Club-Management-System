<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="举办日期" prop="jubanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jubanriqi" 
                type="date"
                placeholder="举办日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubanriqi" label="举办日期" prop="jubanriqi">
              <el-input v-model="ruleForm.jubanriqi" 
                placeholder="举办日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="举办社团" prop="jubanshetuan">
          <el-select v-model="ruleForm.jubanshetuan" placeholder="请选择举办社团">
            <el-option
                v-for="(item,index) in jubanshetuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="举办社团" prop="jubanshetuan">
	      <el-input v-model="ruleForm.jubanshetuan"
                placeholder="举办社团" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动时长" prop="huodongshizhang">
          <el-input v-model="ruleForm.huodongshizhang" 
              placeholder="活动时长" clearable  :readonly="ro.huodongshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动时长" prop="huodongshizhang">
              <el-input v-model="ruleForm.huodongshizhang" 
                placeholder="活动时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='jubanriqi'){
            this.ruleForm.jubanriqi = obj[o];
	    this.ro.jubanriqi = true;
            continue;
          }
          if(o=='jubanshetuan'){
            this.ruleForm.jubanshetuan = obj[o];
	    this.ro.jubanshetuan = true;
            continue;
          }
          if(o=='huodongdidian'){
	    ...
	    this.ro.huodongdidian = true;
          ...
          if(o=='huodongshizhang'){
            this.ruleForm.huodongshizhang = obj[o];
	    this.ro.huodongshizhang = true;
            continue;
          }
          if(o=='huodongneirong'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xiaoyuanshetuan/shetuanmingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.jubanshetuanOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg,'../../../ssmhn4b5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
