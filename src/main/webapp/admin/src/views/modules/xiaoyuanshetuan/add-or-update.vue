<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shetuantupian" label="社团图片" prop="shetuantupian">
          <file-upload
          tip="点击上传社团图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shetuantupian" label="社团图片" prop="shetuantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shetuantupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chenglishijian" label="成立时间" prop="chenglishijian">
              <el-input v-model="ruleForm.chenglishijian" 
                placeholder="成立时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团类别" prop="shetuanleibie">
          <el-input v-model="ruleForm.shetuanleibie" 
              placeholder="社团类别" clearable  :readonly="ro.shetuanleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团类别" prop="shetuanleibie">
              <el-input v-model="ruleForm.shetuanleibie" 
                placeholder="社团类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团人数" prop="shetuanrenshu">
          <el-input v-model="ruleForm.shetuanrenshu" 
              placeholder="社团人数" clearable  :readonly="ro.shetuanrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团人数" prop="shetuanrenshu">
              <el-input v-model="ruleForm.shetuanrenshu" 
                placeholder="社团人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="社团介绍" prop="shetuanjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shetuanjieshao" label="社团介绍" prop="shetuanjieshao">
                    <span v-html="ruleForm.shetuanjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shetuanjieshao = this.ruleForm.shetuanjieshao.replace(reg,'../../../ssmhn4b5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoyuanshetuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoyuanshetuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
